...
class Main(tk.Frame):
    ...
    # Initialize widgets for the main window
    def init_main(self):
        ...
        self.tree = ttk.Treeview(root,
                                 columns=("id","name","salary","phone","email" ),
                                 height=45,
                                 show="headings")
    ...
    def records(self, name, salary, phone, email):
        self.db.insert_data(name, salary, phone, email)
        self.view_records()
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        ...
        label_name = tk.Label(self, text='ЗП')
...
class Db:
    ...
    def insert_data(self, name, phone, salary, email):
        self.cur.execute("""
                         INSERT INTO users (name, phone, salary, email)
